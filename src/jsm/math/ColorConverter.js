...
class ColorConverter {
      ...
      * @returns {Color} The update color.
      */
      ...
      * @param {{ h: number; s: number; v: number }} target - The target object that is used to store the method's
      *   result.
      * @returns {{ h: number; s: number; v: number }} The HSV color.
      */
