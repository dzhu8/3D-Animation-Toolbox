...
/**
 * A capsule is essentially a cylinder with hemispherical caps at both ends. It can be thought of as a swept sphere,
 * where a sphere is moved along a line segment.
 *
...
class Capsule {
      ...
      * @param {number} [radius=1] - The capsule's radius. Default is `1`
      */
      ...
      *
      * @returns {Capsule} A clone of this instance.
      */
     clone() {
     ...
     /**
      * Sets the capsule components to the given values. Please note that this method only copies the values from the
      * given objects.
      *
      * @param {Vector3} start - The start vector.
      * @param {Vector3} end - The end vector
      * @param {number} radius - The capsule's radius.
      * @returns {Capsule} A reference to this capsule.
      */
      ...
      * @returns {boolean} Whether the given bounding box intersects with this capsule.
      */
     intersectsBox(box) {
          return (
               checkAABBAxis(
