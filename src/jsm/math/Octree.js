...
/**
 * An octree is a hierarchical tree data structure used to partition a three-dimensional space by recursively
 ...
 *
 * `Octree` can be used in games to compute collision between the game world and colliders from the player or other
 * dynamic 3D objects.
 *
 * ```js
...
class Octree {
     ...
     constructor(box) {
          ...
          /**
           * The bounds of the Octree. Compared to {@link Octree#box}, no margin is applied.
           *
           * @type {Box3}
           */
     ...
     /**
      * Adds the given triangle to the Octree. The triangle vertices are clamped if they exceed the bounds of the
      * Octree.
      *
      * @param {Triangle} triangle - The triangle to add.
      * @returns {Octree} A reference to this Octree.
      */
      ...
      * @param {Triangle[]} triangles - The target array that holds the triangles.
      */
      ...
      * @returns {Object | false} The intersection object. If no intersection is detected, the method returns `false`.
      */
      ...
      * @returns {Object | boolean} The intersection object. If no intersection is detected, the method returns `false`.
      */
      ...
      *
      * @param {Ray} ray - The ray to test.
      * @returns {Object | boolean} The nearest intersection object. If no intersection is detected, the method returns
      *   `false`.
      */
     rayIntersect(ray) {
          const triangles = [];
