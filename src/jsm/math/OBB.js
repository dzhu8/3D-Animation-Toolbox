...
class OBB {
      ...
      * @param {Vector3} [halfSize] - Positive halfwidth extents of the OBB along each axis.
      * @param {Matrix3} [rotation] - The rotation of the OBB.
      * @returns {OBB} A reference to this OBB.
      */
      ...
      *
      * @returns {OBB} A clone of this instance.
      */
     clone() {
      ...
      * @param {number} [epsilon=Number.EPSILON] - A small value to prevent arithmetic errors. Default is
      *   `Number.EPSILON`
      ...
      * @param {Vector3} target - The target vector that is used to store the method's result.
      * @returns {Vector3 | null} The intersection point. If no intersection is detected, `null` is returned.
      */
      ...
      * @returns {OBB} A reference of this OBB.
      */
     fromBox3(box3) {
     ...
     /**
      * Applies the given transformation matrix to this OBB. This method can be used to transform the bounding volume
      * with the world matrix of a 3D object in order to keep both entities in sync.
      *
