...
/**
 * This class can be used to select 3D objects in a scene with a selection box. It is recommended to visualize the
 * selected area with the help of {@link SelectionHelper}.
 *
 * ```js
...
class SelectionBox {
     ...
     /**
      * This method selects 3D objects in the scene based on the given start and end point. If no parameters are
      * provided, the method uses the start and end values of the respective members.
      *
      * @param {Vector3} [startPoint] - The start point.
      * @param {Vector3} [endPoint] - The end point.
      * @returns {Object3D[]} The selected 3D objects.
      */
