 ...
 *
 * This manual approach to SSAA re-renders the scene ones for each sample with camera jitter and accumulates the
 * results.
 *
 * ```js
...
class SSAARenderPass extends Pass {
      ...
      * @param {?(number | Color | string)} [clearColor=0x000000] - The clear color of the render pass. Default is
      *   `0x000000`
      * @param {number | null} [clearAlpha=0] - The clear alpha of the render pass. Default is `0`
      */
     constructor(scene, camera, clearColor = 0x000000, clearAlpha = 0) {
          ...
          /**
           * The sample level. Specified as n, where the number of samples is 2^n, so sampleLevel = 4, is 2^4 samples,
           * 16.
           *
           * @default 4
           * @type {number}
          ...
          /**
           * Whether the pass should be unbiased or not. This property has the most visible effect when rendering to a
           * RGBA8 buffer because it mitigates rounding errors. By default RGBA16F is used.
           *
           * @default true
           * @type {boolean}
           */
