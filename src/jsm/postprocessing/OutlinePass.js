...
class OutlinePass extends Pass {
      ...
      * @param {Object3D[]} [selectedObjects] - The selected 3D objects that should receive an outline.
      */
     constructor(resolution, scene, camera, selectedObjects) {
          ...
          /**
           * Can be used to highlight selected 3D objects. Requires to set {@link OutlinePass#usePatternTexture} to
           * `true`.
           *
           * @default null
           * @type {Texture | null}
