 ...
 * @property {number} [width=512] - The width of the effect. Default is `512`
 * @property {number} [height=512] - The width of the effect. Default is `512`
 * @property {?Object3D[]} [selects=null] - Which 3D objects should be affected by SSR. If not set, the entire scene is
 *   affected. Default is `null`
 * @property {boolean} [bouncing=false] - Whether bouncing is enabled or not. Default is `false`
 * @property {ReflectorForSSRPass | null} [groundReflector=null] - A ground reflector. Default is `null`
 */
