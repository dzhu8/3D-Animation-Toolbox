import { DataTexture, FloatType, MathUtils, RedFormat, ShaderMaterial, UniformsUtils } from "three";
...
class GlitchPass extends Pass {
      ...
      *
      * @param {number} [dt_size=64] - The size of the displacement texture for digital glitch squares. Default is `64`
      */
