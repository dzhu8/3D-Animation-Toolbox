...
/**
 * This pass can be used to create a post processing effect with a raw GLSL shader object. Useful for implementing
 * custom effects.
 *
 * ```js
...
class ShaderPass extends Pass {
      ...
      * @param {string} [textureID='tDiffuse'] - The name of the texture uniform that should sample the read buffer.
      *   Default is `'tDiffuse'`
      */
