 ...
 *
 * ```js
 * const points = [new THREE.Vector3(-10, 0, 0), new THREE.Vector3(0, 5, 0), new THREE.Vector3(10, 0, 0)];
 *
...
class LineGeometry extends LineSegmentsGeometry {
      ...
      * @returns {LineGeometry} A reference to this geometry.
      */
     setPositions(array) {
      ...
      *
      * @param {(Vector3 | Vector2)[]} points - An array of points in 2D or 3D space.
      * @returns {LineGeometry} A reference to this geometry.
      */
