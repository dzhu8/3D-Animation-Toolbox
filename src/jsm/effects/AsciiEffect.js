...
class AsciiEffect {
     ...
     constructor(renderer, charSet = " .:-=+*#%@", options = {}) {
          ...
          /**
           * The DOM element of the effect. This element must be used instead of the default
           * {@link WebGLRenderer#domElement}.
           *
           * @type {HTMLDivElement}
           */
 ...
 * @property {number} [resolution=0.15] - A higher value leads to more details. Default is `0.15`
 * @property {number} [scale=1] - The scale of the effect. Default is `1`
 * @property {boolean} [color=false] - Whether colors should be enabled or not. Better quality but slows down rendering.
 *   Default is `false`
 * @property {boolean} [alpha=false] - Whether transparency should be enabled or not. Default is `false`
 * @property {boolean} [block=false] - Whether blocked characters should be enabled or not. Default is `false`
 * @property {boolean} [invert=false] - Whether colors should be inverted or not. Default is `false`
 * @property {"low" | "medium" | "high"} [strResolution='low'] - The string resolution. Default is `'low'`
 */
