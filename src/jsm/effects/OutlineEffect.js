 ...
 * @property {number} [defaultThickness=0.003] - The outline thickness. Default is `0.003`
 * @property {number[]} [defaultColor=[0,0,0]] - The outline color. Default is `[0,0,0]`
 * @property {number} [defaultAlpha=1] - The outline alpha value. Default is `1`
 * @property {boolean} [defaultKeepAlive=false] - Whether to keep alive cached internal materials or not. Default is
 *   `false`
 */
