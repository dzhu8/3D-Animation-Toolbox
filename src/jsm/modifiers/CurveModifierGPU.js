 ...
 *
 * @private
 * @param {number} [numberOfCurves=1] - The number of curves needed to be described by this texture. Default is `1`
 ...
 * @param {number} [offset=0] - Which curve slot to write to. Default is `0`
 */
