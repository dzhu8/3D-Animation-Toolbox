...
class TessellateModifier {
      ...
      *
      * @param {number} [maxEdgeLength=0.1] - The maximum edge length. Default is `0.1`
      * @param {number} [maxIterations=6] - The number of iterations. Default is `6`
      */
     ...
     /**
      * Returns a new, modified version of the given geometry by applying a tesselation. Please note that the resulting
      * geometry is always non-indexed.
      *
