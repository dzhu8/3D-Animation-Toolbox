...
/**
 * The modifier can be used to split faces at sharp edges. This allows to compute normals without smoothing the edges
 * which can lead to an improved visual result.
 *
 * ```js
...
class EdgeSplitModifier {
     /**
      * Returns a new, modified version of the given geometry by applying an edge-split operation. Please note that the
      * resulting geometry is always indexed.
      *
      * @param {BufferGeometry} geometry - The geometry to modify.
      * @param {number} cutOffAngle - The cut off angle in radians.
      * @param {boolean} [tryKeepNormals=true] - Whether to try to keep normals or not. Default is `true`
