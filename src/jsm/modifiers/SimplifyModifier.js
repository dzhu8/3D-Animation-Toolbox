import { BufferGeometry, Color, Float32BufferAttribute, Vector2, Vector3, Vector4 } from "three";
...
/**
 * This class can be used to modify a geometry by simplifying it. A typical use case for such a modifier is automatic
 * LOD generation.
 *
 * The implementation is based on [Progressive Mesh type Polygon Reduction
 * Algorithm]{@link https://web.archive.org/web/20230610044040/http://www.melax.com/polychop/} by Stan Melax in 1998.
 *
 * ```js
...
class SimplifyModifier {
     /**
      * Returns a new, modified version of the given geometry by applying a simplification. Please note that the
      * resulting geometry is always non-indexed.
      *
      * @param {BufferGeometry} geometry - The geometry to modify.
      * @param {number} count - The number of vertices to remove.
      * @returns {BufferGeometry} A new, modified geometry.
      */
