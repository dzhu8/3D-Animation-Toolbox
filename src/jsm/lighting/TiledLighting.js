...
/**
 * A custom lighting implementation based on Tiled-Lighting that overwrites the default implementation in
 * {@link WebGPURenderer}.
 *
 * ```js
...
export class TiledLighting extends Lighting {
      ...
      *
      * @param {Light[]} lights - The render object.
      * @returns {TiledLightsNode} The tiled lights node.
      */
     createNode(lights = []) {
