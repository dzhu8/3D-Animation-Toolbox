 ...
 * @property {number | Color | string} [color=0x7F7F7F] - The refractor's color. Default is `0x7F7F7F`
 * @property {number} [textureWidth=512] - The texture width. A higher value results in more clear refractions but is
 *   also more expensive. Default is `512`
 * @property {number} [textureHeight=512] - The texture height. A higher value results in more clear refractions but is
 *   also more expensive. Default is `512`
 * @property {number} [clipBias=0] - The clip bias. Default is `0`
 * @property {Object} [shader] - Can be used to pass in a custom shader that defines how the refractive view is
