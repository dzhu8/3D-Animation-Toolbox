 ...
 *
 * By default the object is centered at the camera, so it is often helpful to set `skybox.position.y = height` to put
...
class GroundedSkybox extends Mesh {
      ...
      * @param {number} height - The height is how far the camera that took the photo was above the ground. A larger
      *   value will magnify the downward part of the image.
      * @param {number} radius - The radius of the skybox. Must be large enough to ensure the scene's camera stays
      *   inside.
      * @param {number} [resolution=128] - The geometry resolution of the skybox. Default is `128`
      */
