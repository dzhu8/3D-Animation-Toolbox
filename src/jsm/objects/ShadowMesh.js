...
/**
 * A Shadow Mesh that follows a shadow-casting mesh in the scene, but is confined to a single plane. This technique can
 * be used as a very performant alternative to classic shadow mapping. However, it has serious limitations like:
 *
...
class ShadowMesh extends Mesh {
     ...
     constructor(mesh) {
          ...
          /**
           * Overwritten to disable automatic matrix update. The local matrix is computed manually in
           * {@link ShadowMesh#update}.
           *
           * @default false
           * @type {boolean}
           */
