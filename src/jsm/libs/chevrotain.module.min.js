...
var Xe = R((N) => {
     ...
     function Cn(t) {
          V.forEach(t, function (e) {
               (bn(e) || ((N.tokenIdxToClass[N.tokenShortNameIdx] = e), (e.tokenTypeIdx = N.tokenShortNameIdx++)),
...
var la = R((Jt) => {
	...
	For Further details.`);
                         ...
                         ((this.tokenMatcher = a ? Rt.tokenStructuredMatcherNoCategories : Rt.tokenStructuredMatcher),
