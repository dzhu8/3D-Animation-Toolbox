 ...
 *
 * The loader returns an instance of {@link CanvasTexture} to represent the animated texture. Two additional properties
 * are added to each texture:
 *
 * - `animation`: The return value of `lottie.loadAnimation()` which is an object with an API for controlling the
...
class LottieLoader extends Loader {
     ...
     constructor(manager) {
          ...
          console.warn(
               "THREE.LottieLoader: The loader has been deprecated and will be removed with r186. Use lottie-web instead and create your animated texture manually."
          );
     }
