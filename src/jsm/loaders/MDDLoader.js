 ...
 *
 * MDD stores a position for every vertex in a model for every frame in an animation. Similar to BVH, it can be used to
 * transfer animation data between different 3D applications or engines.
 *
...
class MDDLoader extends Loader {
      ...
      * @param {function({clip:AnimationClip, morphTargets:(BufferAttribute)[]})} onLoad - Executed when the loading
      ...
      * @returns {{ clip: AnimationClip; morphTargets: BufferAttribute[] }} The result object.
      */
     parse(data) {
