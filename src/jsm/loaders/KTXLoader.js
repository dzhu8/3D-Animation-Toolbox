 ...
 * - [Babylon.JS
 *   khronosTextureContainer.ts]{@link https://github.com/BabylonJS/Babylon.js/blob/master/src/Misc/khronosTextureContainer.ts}
 *
 * ```js
...
class KTXLoader extends CompressedTextureLoader {
      ...
      * @returns {CompressedTextureLoader~TexData} An object representing the parsed texture data.
      */
...
class KhronosTextureContainer {
      ...
      * @param {boolean} textureArrayExpected - Provision for indicating that data should be a texture array, not
      *   implemented
      */
