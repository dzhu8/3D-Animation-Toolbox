...
class Font {
     ...
     /**
      * Generates geometry shapes from the given text and size. The result of this method should be used with
      * {@link ShapeGeometry} to generate the actual geometry data.
      *
      * @param {string} text - The text.
      * @param {number} [size=100] - The text size. Default is `100`
      * @returns {Shape[]} An array of shapes representing the text.
      */
