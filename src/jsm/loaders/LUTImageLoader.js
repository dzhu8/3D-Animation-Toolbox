...
export class LUTImageLoader extends Loader {
     ...
     constructor(manager) {
           ...
           *
           * Depending on the LUT's origin, the texture has green at the bottom (e.g. for Unreal) or green at the top
           * (e.g. for Unity URP Color Lookup). If you're using lut image strips from a Unity pipeline, then set this
           * property to `true`.
           *
           * @default false
           * @type {boolean}
      ...
      * @returns {{ size: number; texture3D: Data3DTexture }} An object representing the parsed LUT.
      */
