import { BufferGeometry, Color, FileLoader, Float32BufferAttribute, Loader, SRGBColorSpace } from "three";

/**
 * A loader for the XYZ format.
 *
 * XYZ is a very simple format for storing point clouds. The layouts `XYZ` (points) and `XYZRGB` (points + colors) are
 * supported.
 *
 * ```js
...
class XYZLoader extends Loader {
      ...
      * @returns {BufferGeometry} The geometry representing the point cloud.
      */
     parse(text) {
