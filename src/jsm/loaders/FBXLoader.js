 ...
 *
 * Requires FBX file to be >= 7.0 and in ASCII or >= 6400 in Binary format. Versions lower than this may load but will
...
class FBXLoader extends Loader {
      ...
      * @returns {Group} An object representing the parsed asset.
      */
...
class FBXTreeParser {
     ...
     parseParameters(materialNode, textureMap, ID) {
          ...
          if (materialNode.Diffuse) {
               parameters.color = ColorManagement.colorSpaceToWorking(
          ...
          if (materialNode.Emissive) {
               parameters.emissive = ColorManagement.colorSpaceToWorking(
          ...
          if (parameters.opacity === 1 || parameters.opacity === 0) {
               ...
               if (parameters.opacity === null) {
                    parameters.opacity =
                         1 - (materialNode.TransparentColor ? parseFloat(materialNode.TransparentColor.value[0]) : 0);
               }
          }
          ...
          if (materialNode.Specular) {
               parameters.specular = ColorManagement.colorSpaceToWorking(
