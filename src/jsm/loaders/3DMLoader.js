 ...
 *
 * Rhinoceros is a 3D modeler used to create, edit, analyze, document, render, animate, and translate NURBS curves,
 * surfaces, breps, extrusions, point clouds, as well as polygon meshes and SubD objects. `rhino3dm.js` is compiled to
 * WebAssembly from the open source geometry library `openNURBS`. The loader currently uses `rhino3dm.js 8.4.0`.
 *
 * ```js
...
class Rhino3dmLoader extends Loader {
      ...
      * @returns {Rhino3dmLoader} A reference to this loader.
      */
     setLibraryPath(path) {
      ...
      * @returns {Promise<Object3D>} A Promise that resolved with the decoded 3D object.
      */
