 ...
 *
 * - [3D
 *   LUTs]{@link http://download.autodesk.com/us/systemdocs/help/2011/lustre/index.html?url=./files/WSc4e151a45a3b785a24c3d9a411df9298473-7ffd.htm,topicNumber=d0e9492}
 * - [Format Spec for
 *   .3dl]{@link https://community.foundry.com/discuss/topic/103636/format-spec-for-3dl?mode=Post&postID=895258}
 *
 * ```js
...
export class LUT3dlLoader extends Loader {
      ...
      * @returns {LUT3dlLoader} A reference to this loader.
      */
     setType(type) {
          this.type = type;
      ...
      * @param {function({size:number,texture3D:Data3DTexture})} onLoad - Executed when the loading process has been
      *   finished.
      ...
      * @returns {{ size: number; texture3D: Data3DTexture }} The parsed 3DL LUT.
      */
     parse(input) {
