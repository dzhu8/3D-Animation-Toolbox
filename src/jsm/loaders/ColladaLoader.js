 ...
 *
 * The Collada format is very complex so this loader only supports a subset of what is defined in the [official
 * specification]{@link https://www.khronos.org/files/collada_spec_1_5.pdf}.
 *
 * Assets with a Z-UP coordinate system are transformed it into Y-UP by a simple rotation. The vertex data are not
 * converted.
 *
 * ```js
...
class ColladaLoader extends Loader {
      ...
      * @param {function({scene:Group,animations:(AnimationClip)[],kinematics:Object})} onLoad - Executed when the
      *   loading process has been finished.
     ...
     /**
      * Parses the given Collada data and returns a result object holding the parsed scene, an array of animation clips
      * and kinematics.
      *
      * @param {string} text - The raw Collada data as a string.
      * @param {string} path - The asset path.
      * @returns {{ scene: Group; animations: AnimationClip[]; kinematics: Object }} An object representing the parsed
      *   asset.
      */
     parse(text, path) {
