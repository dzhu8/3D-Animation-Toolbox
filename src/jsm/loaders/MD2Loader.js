 ...
 *
 * The loader represents the animations of the MD2 asset as an array of animation clips and stores them in the
 * `animations` property of the geometry.
 *
 * ```js
...
class MD2Loader extends Loader {
      ...
      * @returns {BufferGeometry} The parsed geometry data.
      */
     parse(buffer) {
