 ...
 *
 * Scalable Vector Graphics is an XML-based vector image format for two-dimensional graphics with support for
...
class SVGLoader extends Loader {
      ...
      * @param {function({paths:(ShapePath)[],xml:string})} onLoad - Executed when the loading process has been
      *   finished.
      ...
      * @returns {{ paths: ShapePath[]; xml: string }} An object holding an array of shape paths and the SVG XML
      *   document.
      */
     parse(text) {
          const scope = this;
           ...
           * https://mortoray.com/2017/02/16/rendering-an-svg-elliptical-arc-as-bezier-curves/ Appendix: Endpoint to
           * center arc conversion From rx ry x-axis-rotation large-arc-flag sweep-flag x y To aX, aY, xRadius, yRadius,
      ...
      * @returns {Shape[]} An array of shapes.
      */
      ...
      *
      * @param {number} [width=1] - The stroke width. Default is `1`
      * @param {string} [color='#000'] - The stroke color, as returned by {@link Color#getStyle}. Default is `'#000'`
      * @param {"round" | "bevel" | "miter" | "miter-limit"} [lineJoin='miter'] - The line join style. Default is
      *   `'miter'`
      * @param {"round" | "square" | "butt"} [lineCap='butt'] - The line cap style. Default is `'butt'`
      * @param {number} [miterLimit=4] - Maximum join length, in multiples of the `width` parameter (join is truncated
      *   if it exceeds that distance). Default is `4`
      ...
      *
      * @param {Vector2[]} points - The points in 2D space. Minimum 2 points. The path can be open or closed (last point
      *   equals to first point).
      * @param {Object} style - Object with SVG properties as returned by `SVGLoader.getStrokeStyle()`, or
      *   `SVGLoader.parse()` in the `path.userData.style` object.
      * @param {number} [arcDivisions=12] - Arc divisions for round joins and endcaps. Default is `12`
      * @param {number} [minDistance=0.001] - Points closer to this distance will be merged. Default is `0.001`
      * @returns {BufferGeometry | null} The stroke geometry. UV coordinates are generated ('u' along path. 'v' across
      *   it, from left to right). Returns `null` if not geometry was generated.
      */
     static pointsToStroke(points, style, arcDivisions, minDistance) {
          ...
          if (
               SVGLoader.pointsToStrokeWithBuffers(points, style, arcDivisions, minDistance, vertices, normals, uvs) ===
               0
          ) {
               return null;
          }
      ...
      * Creates a stroke from an array of points.
      *
      * @param {Vector2[]} points - The points in 2D space. Minimum 2 points.
      * @param {Object} style - Object with SVG properties as returned by `SVGLoader.getStrokeStyle()`, or
      *   `SVGLoader.parse()` in the `path.userData.style` object.
      * @param {number} [arcDivisions=12] - Arc divisions for round joins and endcaps. Default is `12`
      * @param {number} [minDistance=0.001] - Points closer to this distance will be merged. Default is `0.001`
      * @param {number[]} vertices - An array holding vertices.
      * @param {number[]} normals - An array holding normals.
      * @param {number[]} uvs - An array holding uvs.
      * @param {number} [vertexOffset=0] - The vertex offset. Default is `0`
