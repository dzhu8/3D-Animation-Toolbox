...
class TDSLoader extends Loader {
      ...
      * @returns {Group} The parsed asset represented as a group.
      */
      ...
      * @param {Chunk} chunk - Chunk in use.
      * @param {string} path - Path for external resources.
      * @returns {Texture} Texture read from this data chunk.
      */
     readMap(chunk, path) {
          let next = chunk.readChunk();
          let texture = {};
      ...
      * @private
      * @param {Chunk} chunk - Chunk in use.
      * @returns {Object} Object with name and index of the object.
      */
      ...
      * @returns {Color} Color value read.
      */
     readColor(chunk) {
          const subChunk = chunk.readChunk();
      ...
      * @returns {number} Data read from the dataview.
      */
...
class Chunk {
      ...
      *
      * @private
      * @returns {Chunk | null} Next sub chunk.
      */
     readChunk() {
          if (this.endOfChunk) {
               return null;
      ...
      *
      * @private
      * @returns {string} Hex-string of id
      */
     get hexId() {
      ...
      *
      * @private
      * @returns {string} Data read from the dataview.
      */
     readString() {
          let s = "";
          let c = this.readByte();
