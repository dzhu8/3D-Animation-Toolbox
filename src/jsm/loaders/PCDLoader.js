...
class PCDLoader extends Loader {
      ...
      * @returns {Points} The parsed point cloud.
      */
     parse(data) {
                    ...
                    if (offset.x !== undefined) {
                         ...
                         position.push(
                              this._getDataView(
                                   ...
                                   PCDheader.type[xIndex],
                                   PCDheader.size[xIndex]
                              )
                         );
                         position.push(
                              this._getDataView(
                                   ...
                                   PCDheader.type[yIndex],
                                   PCDheader.size[yIndex]
                              )
                         );
                         position.push(
                              this._getDataView(
                                   ...
                                   PCDheader.type[zIndex],
                                   PCDheader.size[zIndex]
                              )
                         );
                    }
                    ...
                    if (offset.intensity !== undefined) {
                         ...
                         intensity.push(
                              this._getDataView(
                                   ...
                                   PCDheader.type[intensityIndex],
                                   PCDheader.size[intensityIndex]
                              )
                         );
                    }
