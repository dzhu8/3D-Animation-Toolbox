 ...
 *
 * The [Protein Data Bank]{@link https://en.wikipedia.org/wiki/Protein_Data_Bank_(file_format)} file format is a textual
 * file describing the three-dimensional structures of molecules.
 *
 * ```js
...
class PDBLoader extends Loader {
     ...
     /**
      * Parses the given PDB data and returns an object holding the atoms and bond geometries as well as the raw atom
      * data as JSON.
      *
