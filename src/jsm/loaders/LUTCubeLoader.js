import { ClampToEdgeWrapping, Data3DTexture, FileLoader, LinearFilter, Loader, UnsignedByteType, Vector3 } from "three";
 ...
 *
 * - [Cube LUT
 *   Specification]{@link https://web.archive.org/web/20220220033515/https://wwwimages2.adobe.com/content/dam/acom/en/products/speedgrade/cc/pdfs/cube-lut-specification-1.0.pdf}
 *
 * ```js
...
export class LUTCubeLoader extends Loader {
      ...
      * @returns {LUTCubeLoader} A reference to this loader.
      */
     setType(type) {
          this.type = type;
      ...
      * @param {function({title:string,size:number,domainMin:Vector3,domainMax:Vector3,texture3D:Data3DTexture})} onLoad
