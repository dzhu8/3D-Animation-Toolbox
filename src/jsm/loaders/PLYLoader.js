import { BufferGeometry, FileLoader, Float32BufferAttribute, Loader, Color, SRGBColorSpace } from "three";
...
class PLYLoader extends Loader {
     ...
     /**
      * Sets a property name mapping that maps default property names to custom ones. For example, the following maps
      * the properties “diffuse_(red|green|blue)” in the file to standard color names.
      *
      * ```js
     ...
     /**
      * Custom properties outside of the defaults for position, uv, normal and color attributes can be added using the
      * setCustomPropertyNameMapping method. For example, the following maps the element properties “custom_property_a”
      * and “custom_property_b” to an attribute “customAttribute” with an item size of 2. Attribute item sizes are set
      * from the number of element properties in the property array.
      *
      * ```js
