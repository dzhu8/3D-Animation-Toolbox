...
class LWOLoader extends Loader {
      ...
      * @param {function({meshes:(Mesh)[],materials:(Material)[]})} onLoad - Executed when the loading process has been
      *   finished.
      ...
      * @returns {{ meshes: Mesh[]; materials: Material[] }} An object holding the parse meshes and materials.
      */
