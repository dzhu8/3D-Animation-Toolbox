...
class DotScreenNode extends TempNode {
      ...
      * @param {number} [angle=1.57] - The rotation of the effect in radians. Default is `1.57`
      * @param {number} [scale=1] - The scale of the effect. A higher value means smaller dots. Default is `1`
      */
