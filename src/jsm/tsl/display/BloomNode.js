 ...
 * ```
 *
 * By default, the node affects the entire image. For a selective bloom, use the `emissive` material property to control
 * which objects should contribute to bloom or not. This can be achieved via MRT.
 *
 * ```js
 * const postProcessing = new THREE.PostProcessing(renderer);
 *
...
class BloomNode extends TempNode {
      ...
      * @param {number} [strength=1] - The strength of the bloom. Default is `1`
      * @param {number} [radius=0] - The radius of the bloom. Default is `0`
      * @param {number} [threshold=0] - The luminance threshold limits which bright areas contribute to the bloom
      *   effect. Default is `0`
      */
