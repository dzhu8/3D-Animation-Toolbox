...
class AfterImageNode extends TempNode {
      ...
      * @param {number} [damp=0.96] - The damping intensity. A higher value means a stronger after image effect. Default
      *   is `0.96`
      */
     constructor(textureNode, damp = 0.96) {
          ...
          /**
           * How quickly the after-image fades. A higher value means the after-image persists longer, while a lower
           * value means it fades faster. Should be in the range `[0, 1]`.
           *
 ...
 * @param {number} [damp=0.96] - The damping intensity. A higher value means a stronger after image effect. Default is
 *   `0.96`
