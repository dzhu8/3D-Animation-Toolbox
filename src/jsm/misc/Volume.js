...
/**
 * This class had been written to handle the output of the {@link NRRDLoader}. It contains a volume of data and
 * information about it. For now it only handles 3 dimensional data.
 *
...
class Volume {
     ...
     constructor(xLength, yLength, zLength, type, arrayBuffer) {
          ...
          Object.defineProperty(this, "lowerThreshold", {
               ...
               /**
                * The voxels with values under this threshold won't appear in the slices. If changed,
                * geometryNeedsUpdate is automatically set to true on all the slices associated to this volume.
                *
                * @type {number}
                * @param {number} value
          ...
          Object.defineProperty(this, "upperThreshold", {
               ...
               /**
                * The voxels with values over this threshold won't appear in the slices. If changed, geometryNeedsUpdate
                * is automatically set to true on all the slices associated to this volume
                *
                * @type {number}
                * @param {number} value
      ...
      * @returns {number[]} The IJK coordinates as `[x,y,z]`.
      */
     reverseAccess(index) {
      ...
      *
      * @param {Function} functionToMap A function to apply to every voxel, will be called with the following
      *   parameters: value of the voxel, index of the voxel, the data (TypedArray).
     ...
     /**
      * Compute the orientation of the slice and returns all the information relative to the geometry such as
      * sliceAccess, the plane matrix (orientation and position in RAS coordinate) and the dimensions of the plane in
      * both coordinate system.
      *
     ...
     /**
      * Returns a slice corresponding to the given axis and index. The coordinate are given in the Right Anterior
      * Superior coordinate format.
      *
      * @param {"x" | "y" | "z"} axis - The normal axis to the slice.
      ...
      *
      * @returns {number[]} The min/max data as `[min,max]`.
      */
     computeMinMax() {
          let min = Infinity;
          let max = -Infinity;
