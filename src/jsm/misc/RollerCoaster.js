import { BufferAttribute, BufferGeometry, Color, Quaternion, Raycaster, SRGBColorSpace, Vector3 } from "three";
...
class TreesGeometry extends BufferGeometry {
      ...
      * Constructs a new geometry.
      *
      * @param {Mesh} landscape - A mesh representing the landscape. Trees will be positioned randomly on the
      *   landscape's surface.
      */
