 ...
 *
 * This class can only be used with {@link WebGLRenderer}. When using {@link WebGPURenderer}, import from
...
class ProgressiveLightMap {
      ...
      * @param {number} [res=1024] - The side-long dimension of the total lightmap. Default is `1024`
      */
