 ...
 *
 * Each variable has a fragment shader that defines the computation made to obtain the variable in question. You can use
 * as many variables you need, and make dependencies so you can use textures of other variables in the shader (the
 * sampler uniforms are added automatically) Most of the variables will need themselves as dependency.
 *
 * The renderer has actually two render targets per variable, to make ping-pong. Textures from the current frame are
 * used as inputs to render the textures of the next frame.
 *
 * The render targets of the variables can be used as input textures for your visualization shaders.
 *
 * Variable names should be valid identifiers and should not collide with THREE GLSL used identifiers. a common approach
 * could be to use 'texture' prefixing the variable name; i.e texturePosition, textureVelocity...
 *
...
class GPUComputationRenderer {
     ...
     constructor(sizeX, sizeY, renderer) {
           ...
           * @returns {GPUComputationRenderer} A reference to this renderer.
           */
           ...
           * @returns {Object} The compute variable.
           */
           ...
           * @param {Object[]} dependencies - Other compute variables that represents the dependencies.
           */
           ...
           *
           * @returns {string | null} Returns `null` if no errors are detected. Otherwise returns the error message.
           */
          this.init = function () {
           ...
           *
           * @param {Object} variable - The compute variable.
           * @returns {WebGLRenderTarget} The current render target.
           */
           ...
           *
           * @param {Object} variable - The compute variable.
           * @returns {WebGLRenderTarget} The alternate render target.
           */
