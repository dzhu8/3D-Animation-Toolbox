...
/**
 * A special type of an animated mesh with a simple interface for animation playback. It allows to playback just one
 * animation without any transitions or fading between animation changes.
 *
 * @augments Mesh
...
class MorphAnimMesh extends Mesh {
      ...
      * @param {Material | Material[]} [material] - The mesh material.
      */
     ...
     /**
      * Plays the defined animation clip. The implementation assumes the animation clips are stored in
      * {@link Object3D#animations} or the geometry.
      *
