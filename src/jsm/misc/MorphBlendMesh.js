...
/**
 * A special type of an animated mesh with a more advanced interface for animation playback. Unlike
 * {@link MorphAnimMesh}. It allows to playback more than one morph animation at the same time but without fading
 * options.
 *
 * @augments Mesh
...
class MorphBlendMesh extends Mesh {
     ...
     /**
      * Automatically creates animations based on the values in {@link Mesh#morphTargetDictionary}.
      *
