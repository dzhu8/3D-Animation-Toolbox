...
export class KTX2Exporter {
      ...
      *
      * @async
      * @param {DataTexture | Data3DTexture | WebGPURenderer | WebGLRenderer} arg1 - The data texture to export or a
      *   renderer.
      * @param {RenderTarget} [arg2] - The render target that should be exported
      * @returns {Promise<Uint8Array>} A Promise that resolves with the exported KTX2.
      */
     async parse(arg1, arg2) {
          ...
          for (let i = 0; i < channelCount; ++i) {
               ...
               if (
                    ...
                    basicDesc.transferFunction !== KHR_DF_TRANSFER_LINEAR
               ) {
