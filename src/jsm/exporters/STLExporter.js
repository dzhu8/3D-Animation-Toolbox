 ...
 * texture or other common model attributes. The STL format specifies both ASCII and binary representations, with binary
 * being more compact. STL files contain no scale information or indexes, and the units are arbitrary.
 *
 * ```js
...
class STLExporter {
      ...
      * @returns {string | ArrayBuffer} The exported STL.
      */
     parse(scene, options = {}) {
