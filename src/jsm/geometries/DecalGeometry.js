import { BufferGeometry, Euler, Float32BufferAttribute, Matrix3, Matrix4, Mesh, Vector3 } from "three";

/**
 * This class can be used to create a decal mesh that serves different kinds of purposes e.g. adding unique details to
 * models, performing dynamic visual environmental changes or covering seams.
 *
 * Please not that decal projections can be distorted when used around corners. More information at this GitHub issue:
 * [Decal projections without distortions]{@link https://github.com/mrdoob/three.js/issues/21187}.
 *
