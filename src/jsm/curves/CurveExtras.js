 ...
 *
 * Formulas collected from various sources http://mathworld.wolfram.com/HeartCurve.html
 * http://en.wikipedia.org/wiki/Viviani%27s_curve http://www.mi.sanu.ac.rs/vismath/taylorapril2011/Taylor.pdf
...
class HeartCurve extends Curve {
      ...
      *
      * @param {number} [scale=5] - The curve's scale. Default is `5`
      */
     constructor(scale = 5) {
          super();
...
class VivianiCurve extends Curve {
      ...
      *
      * @param {number} [scale=70] - The curve's scale. Default is `70`
      */
...
class TrefoilKnot extends Curve {
      ...
      *
      * @param {number} [scale=10] - The curve's scale. Default is `10`
      */
...
class FigureEightPolynomialKnot extends Curve {
      ...
      *
      * @param {number} [scale=1] - The curve's scale. Default is `1`
      */
     constructor(scale = 1) {
          super();
