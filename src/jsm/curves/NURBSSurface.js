...
class NURBSSurface {
      ...
      * @param {(Vector2 | Vector3 | Vector4)[][]} controlPoints - An array^2 holding control points.
      */
     ...
     /**
      * This method returns a vector in 3D space for the given interpolation factor. This vector lies on the NURBS
      * surface.
      *
      * @param {number} t1 - The first interpolation factor representing the `u` position on the surface. Must be in the
      *   range `[0,1]`.
      * @param {number} t2 - The second interpolation factor representing the `v` position on the surface. Must be in
      *   the range `[0,1]`.
