 ...
 * @param {number[]} U - The knot vector.
 ...
 * @param {number} p - The degree.
 * @param {number[]} U - The knot vector.
 * @returns {number[]} Array[p+1] with basis functions values.
 */
 ...
 * @param {number[]} U - The knot vector.
 * @param {Vector4[]} P - The control points
 * @param {number} u - The parametric point.
 * @returns {Vector4} The point for given `u`.
 */
 ...
 * @param {number[]} U - The knot vector.
 * @returns {number[][]} An array[n+1][p+1] with basis functions derivatives.
 */
 ...
 * @returns {Vector4[]} An array[d+1] with derivatives.
 */
 ...
 *
 * @param {Vector4[]} Pders - Array with derivatives.
 * @returns {Vector3[]} An array with derivatives for rational curve.
 */
 ...
 * @param {number} p - The degree.
 * @param {number[]} U - The knot vector.
 * @param {Vector4[]} P - The control points in homogeneous space.
 * @param {number} u - The parametric point.
 * @param {number} nd - The number of derivatives.
 * @returns {Vector3[]} Array with derivatives for rational curve.
 */
 ...
 * @param {number[]} U - The first knot vector.
 * @param {number[]} V - The second knot vector.
 * @param {Vector4[][]} P - The control points in homogeneous space.
 ...
 * @param {number[]} U - The first knot vector.
 * @param {number[]} V - The second knot vector.
 * @param {number[]} W - The third knot vector.
 * @param {Vector4[][][]} P - The control points in homogeneous space.
 * @param {number} u - The first parametric point.
 * @param {number} v - The second parametric point.
