 ...
 *
 * Requires that normals have been specified in the geometry as a buffer attribute or have been calculated using
 * {@link BufferGeometry#computeVertexNormals}.
 *
 * ```js
...
class VertexNormalsHelper extends LineSegments {
      ...
      * @param {number} [size=1] - The helper's size. Default is `1`
      * @param {number | Color | string} [color=0xff0000] - The helper's color. Default is `0xff0000`
      */
     constructor(object, size = 1, color = 0xff0000) {
          ...
          /**
           * Overwritten and set to `false` since the object's world transformation is encoded in the helper's geometry
           * data.
           *
           * @default false
           * @type {boolean}
