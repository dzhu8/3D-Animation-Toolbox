...
/**
 * A special type of helper that visualizes the camera's transformation in a small viewport area as an axes helper. Such
 * a helper is often wanted in 3D modeling tools or scene editors like the [three.js
 * editor]{@link https://threejs.org/editor}.
 *
...
class ViewHelper extends Object3D {
     ...
     constructor(camera, domElement) {
           ...
           * @returns {boolean} Whether an intersection with the helper has been detected or not.
           */
           ...
           *
           * @param {string} [font='24px Arial'] - The label font. Default is `'24px Arial'`
           * @param {string} [color='#000000'] - The label color. Default is `'#000000'`
           * @param {number} [radius=14] - The label radius. Default is `14`
           */
