...
/**
 * Fires if any type of change (object or property change) is performed. Property changes are separate events you can
 * add event listeners to. The event type is "propertyname-changed".
 *
 * @type {Object}
...
class TransformControls extends Controls {
     ...
     constructor(camera, domElement = null) {
          ...
          /**
           * By default, 3D objects are continuously translated. If you set this property to a numeric value (world
           * units), you can define in which steps the 3D object should be translated.
           *
           * @default null
           * @type {number | null}
          ...
          /**
           * By default, 3D objects are continuously rotated. If you set this property to a numeric value (radians), you
           * can define in which steps the 3D object should be rotated.
           *
           * @default null
           * @type {number | null}
          ...
          /**
           * By default, 3D objects are continuously scaled. If you set this property to a numeric value, you can define
           * in which steps the 3D object should be scaled.
           *
           * @default null
           * @type {number | null}
      ...
      * attached 3D object.
      *
      * @returns {TransformControlsRoot} The helper.
      */
     getHelper() {
          return this._root;
     }
      ...
      * @returns {TransformControls} A reference to this controls.
      */
     attach(object) {
          this.object = object;
      ...
      *
      * @param {number | null} translationSnap - The translation snap to set.
      */
      ...
      *
      * @param {number | null} rotationSnap - The rotation snap to set.
      */
      ...
      * Sets the scale snap.
      *
      * @param {number | null} scaleSnap - The scale snap to set.
      */
