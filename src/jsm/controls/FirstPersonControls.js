...
class FirstPersonControls extends Controls {
     ...
     constructor(object, domElement = null) {
          ...
          /**
           * Whether or not the camera's height influences the forward movement speed. Use the properties `heightCoef`,
           * `heightMin` and `heightMax` for configuration.
           *
           * @default false
           * @type {boolean}
           */
      ...
      *
      * @param {number | Vector3} x - The x coordinate of the target position or alternatively a vector representing the
      *   target position.
      * @param {number} y - The y coordinate of the target position.
      * @param {number} z - The z coordinate of the target position.
      * @returns {FirstPersonControls} A reference to this controls.
      */
     lookAt(x, y, z) {
          if (x.isVector3) {
               _target.copy(x);
