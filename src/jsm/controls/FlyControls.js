...
/**
 * This class enables a navigation similar to fly modes in DCC tools like Blender. You can arbitrarily transform the
 * camera in 3D space without any limitations (e.g. focus on a specific target).
 *
 * @augments Controls
