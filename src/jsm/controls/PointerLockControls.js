...
/**
 * The implementation of this class is based on the [Pointer Lock
 * API]{@link https://developer.mozilla.org/en-US/docs/Web/API/Pointer_Lock_API}. `PointerLockControls` is a perfect
 * choice for first person 3D games.
 *
 * ```js
...
class PointerLockControls extends Controls {
      ...
      * @returns {Vector3} The normalized direction vector.
      */
     getDirection(v) {
      ...
      *   raw mouse input instead. Setting it to true will disable mouse acceleration. Default is `false`
      */
