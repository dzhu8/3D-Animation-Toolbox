...
async function JoltPhysics() {
     ...
     return {
          /**
           * Adds the given scene to this physics simulation. Only meshes with a `physics` object in their
           * {@link Object3D#userData} field will be honored. The object can be used to store the mass and restitution of
           * the mesh. E.g.:
           *
           * ```js
           ...
           * @param {number} [mass=0] The mass in kg of the mesh. Default is `0`
           * @param {number} [restitution=0] The restitution/friction of the mesh. Default is `0`
           * @name JoltPhysics#addMesh
           */
          addMesh: addMesh,

          /**
           * Set the position of the given mesh which is part of the physics simulation. Calling this method will reset
           * the current simulated velocity of the mesh.
           *
           * @function
           * @param {Mesh} mesh The mesh to update the position for.
           * @param {Vector3} position - The new position.
           * @param {number} [index=0] - If the mesh is instanced, the index represents the instanced ID. Default is `0`
