...
class SceneOptimizer {
     ...
     _getMaterialPropertiesHash(material) {
          ...
          const attenuationHash = material.attenuationColor ? material.attenuationColor.getHexString() : 0;
          const sheenColorHash = material.sheenColor ? material.sheenColor.getHexString() : 0;

          return [material.type, physicalProps, mapHash, emissiveHash, attenuationHash, sheenColorHash].join("_");
     }
     ...
     _getGeometryHash(geometry) {
          const indexHash = geometry.index ? this._bufferToHash(geometry.index.array) : "noIndex";
     ...
     removeEmptyNodes(object) {
          ...
          for (const child of children) {
               ...
               if (
                    (child instanceof THREE.Group || child.constructor === THREE.Object3D) &&
