...
class WebGL {
      ...
      * @returns {boolean} Whether the given color space is available or not.
      */
     ...
     /**
      * Returns a `div` element representing a formatted error message that can be appended in web sites if WebGL 2
      * isn't supported.
      *
      * @returns {HTMLDivElement} A `div` element representing a formatted error message that WebGL 2 isn't supported.
      */
