...
class WebGPU {
      ...
      *
      * @returns {boolean} Whether WebGPU is available or not.
      */
     static isAvailable() {
     ...
     /**
      * Returns a `div` element representing a formatted error message that can be appended in web sites if WebGPU isn't
      * supported.
      *
      * @returns {HTMLDivElement} A `div` element representing a formatted error message that WebGPU isn't supported.
      */
