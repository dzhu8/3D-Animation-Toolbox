...
class AnimationClipCreator {
     /**
      * Creates an animation clip that rotates a 3D object 360 degrees in the given period of time around the given
      * axis.
      *
      * @param {number} period - The duration of the animation.
      * @param {"x" | "y" | "z"} [axis='x'] - The axis of rotation. Default is `'x'`
      * @returns {AnimationClip} The created animation clip.
      */
     ...
     /**
      * Creates an animation clip that scales a 3D object from `0` to `1` in the given period of time along the given
      * axis.
      *
      * @param {number} period - The duration of the animation.
      * @param {"x" | "y" | "z"} [axis='x'] - The axis to scale the 3D object along. Default is `'x'`
      * @returns {AnimationClip} The created animation clip.
      */
      ...
      *
      * @param {number} duration - The duration of the animation.
      * @param {Color[]} colors - An array of colors that should be sequentially animated.
      * @returns {AnimationClip} The created animation clip.
      */
