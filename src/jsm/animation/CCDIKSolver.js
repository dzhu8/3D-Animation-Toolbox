...
/**
 * This class solves the Inverse Kinematics Problem with a [CCD
 * Algorithm]{@link https://web.archive.org/web/20221206080850/https://sites.google.com/site/auraliusproject/ccd-algorithm}.
 *
...
class CCDIKSolver {
      ...
      * @param {(CCDIKSolver~IK)[]} [iks=[]] - The IK objects. Default is `[]`
      */
      ...
      *   Default is `1.0`
      * @returns {CCDIKSolver} A reference to this instance.
      */
      ...
      * @returns {CCDIKHelper} The created helper.
      */
...
class CCDIKHelper extends Object3D {
      ...
      * @param {SkinnedMesh} mesh - The skinned mesh.
      * @param {(CCDIKSolver~IK)[]} [iks=[]] - The IK objects. Default is `[]`
      * @param {number} [sphereSize=0.25] - The sphere size. Default is `0.25`
      */
 ...
 * @property {(CCDIKSolver~BoneLink)[]} links - An array of bone links.
 * @property {number} [iteration=1] - Iteration number of calculation. Smaller is faster but less precise. Default is
 *   `1`
 ...
 * @property {boolean} [enabled=true] - Whether the link is enabled or not. Default is `true`
 */
