...
class CSMFrustum {
     ...
     constructor(data) {
          ...
          /**
           * The zNear value. This value depends on whether the CSM is used with WebGL or WebGPU. Both API use different
      ...
      *
      * @param {number[]} breaks - An array of numbers in the range `[0,1]` the defines how the CSM frustum should be
      *   split up.
      * @param {CSMFrustum[]} target - The target array that holds the new CSM frustums.
      */
     split(breaks, target) {
