 ...
 *
 * This module can only be used with {@link WebGLRenderer}. When using {@link WebGPURenderer}, use {@link CSMShadowNode}
 * instead.
 *
...
export class CSM {
     ...
     constructor(data) {
          ...
          /**
           * An array of directional lights which cast the shadows for the different cascades. There is one directional
           * light for each cascade.
           *
     ...
     /**
      * Computes the breaks of this CSM instance based on the scene's camera, number of cascades and the selected split
      * mode.
      *
      * @private
      */
      ...
      *
      * @private
      * @param {Vector2[]} target - The target array that holds the extended breaks.
      */
 ...
 * @property {number} [cascades=3] - The number of cascades. Default is `3`
 * @property {number} [maxFar=100000] - The maximum far value. Default is `100000`
 * @property {"practical" | "uniform" | "logarithmic" | "custom"} [mode='practical'] - The frustum split mode. Default
 *   is `'practical'`
 * @property {Function} [customSplitsCallback] - Custom split callback when using `mode='custom'`.
 * @property {number} [shadowMapSize=2048] - The shadow map size. Default is `2048`
 * @property {number} [shadowBias=0.000001] - The shadow bias. Default is `0.000001`
 * @property {Vector3} [lightDirection] - The light direction.
 * @property {number} [lightIntensity=3] - The light intensity. Default is `3`
 * @property {number} [lightNear=1] - The light near value. Default is `1`
 * @property {number} [lightNear=2000] - The light far value. Default is `2000`
 * @property {number} [lightMargin=200] - The light margin. Default is `200`
 */
