...
/**
 * A specialized version of {@link CSS3DObject} that represents DOM elements as sprites.
 *
...
/**
 * This renderer can be used to apply hierarchical 3D transformations to DOM elements via the CSS3
 * [transform]{@link https://www.w3schools.com/cssref/css3_pr_transform.asp} property. `CSS3DRenderer` is particularly
 * interesting if you want to apply 3D effects to a website without canvas based rendering. It can also be used in order
 * to combine DOM elements with WebGLcontent.
 *
 ...
 *
 * So `CSS3DRenderer` is just focused on ordinary DOM elements. These elements are wrapped into special 3D objects
 * ({@link CSS3DObject} or {@link CSS3DSprite}) and then added to the scene graph.
 *
...
class CSS3DRenderer {
     ...
     constructor(parameters = {}) {
           ...
           *
           * @returns {{ width: number; height: number }} The size of the renderer.
           */
 ...
 * @property {DOMElement} [element] - A DOM element where the renderer appends its child-elements. If not passed in
 *   here, a new div element will be created.
 */
