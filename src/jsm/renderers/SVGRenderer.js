import { Box2, Camera, Color, Matrix3, Matrix4, Object3D, SRGBColorSpace, Vector3 } from "three";
...
/**
 * This renderer an be used to render geometric data using SVG. The produced vector graphics are particular useful in
 ...
 *
 * `SVGRenderer` has various advantages. It produces crystal-clear and sharp output which is independent of the actual
 * viewport resolution.SVG elements can be styled via CSS. And they have good accessibility since it's possible to add
 * metadata like title or description (useful for search engines or screen readers).
 *
...
class SVGRenderer {
     ...
     constructor() {
          ...
          /**
           * Sets the render quality. Setting to `high` means This value indicates that the browser tries to improve the
           * SVG quality over rendering speed and geometric precision.
           *
