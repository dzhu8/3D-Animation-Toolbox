...
/**
 * This class can project a given scene in 3D space into a 2D representation used for rendering with a 2D API.
 * `Projector` is currently used by {@link SVGRenderer} and was previously used by the legacy `CanvasRenderer`.
 *
...
class Projector {
     ...
     constructor() {
          ...
          /**
           * Projects the given scene in 3D space into a 2D representation. The result is an object with renderable
           * items.
           *
           ...
           * @returns {{ objects: Objects[]; lights: Objects[]; elements: Objects[] }} The projected scene as renderable
           *   objects.
           */
