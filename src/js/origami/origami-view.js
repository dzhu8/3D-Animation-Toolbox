...
function loadInteractiveCraneModel() {
     ...
     loader.load(
          ...
          function (object) {
               ...
               console.log(
                    `Set 1: Faces [${animationSet1.selectedFaceIndices.join(", ")}] with hinge edge ${animationSet1.hingeEdgeIndex}`
               );
               console.log(
                    `Set 2: Faces [${animationSet2.selectedFaceIndices.join(", ")}] with hinge edge ${animationSet2.hingeEdgeIndex}`
               );
...
function setupHingeEdgeData() {
     ...
     if (edges.length > animationSet1.hingeEdgeIndex) {
          ...
          console.warn(
               `Hinge edge index ${animationSet1.hingeEdgeIndex} for Set 1 is out of range. Total edges: ${edges.length}`
          );
     }
     ...
     if (edges.length > animationSet2.hingeEdgeIndex) {
          ...
          console.warn(
               `Hinge edge index ${animationSet2.hingeEdgeIndex} for Set 2 is out of range. Total edges: ${edges.length}`
          );
     }
}
...
function applyCombinedHingeAnimation() {
     ...
     const set1Data =
          animationSet1.selectedFaceIndices.length > 0
               ? {
     ...
     const set2Data =
          animationSet2.selectedFaceIndices.length > 0
               ? {
