...
THREE.VRController = function (gamepad) {
     ...
     this.listenForButtonEvents = function () {
          ...
          if (hand !== controller.gamepad.hand) {
               if (verbosity >= 0.5)
                    console.log(prefix + 'hand changed from "' + hand + '" to "' + controller.gamepad.hand + '"');
          ...
          buttons.forEach(function (button, i) {
               var prefixFull = prefix + button.name + " ",
...
OrientationArmModel.prototype.update = function () {
     ...
     var lerpValue =
          lerpSuppression * (elbowRatio + wristRatio * extensionRatio * OrientationArmModel.EXTENSION_RATIO_WEIGHT);
